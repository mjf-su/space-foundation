...
input_filename = "../preprocessed-data/msl_datalog_with_bbox.pickle"
output_filename = "../preprocessed-data/msl_datalog_with_vqa.pickle"

with open(input_filename, "rb") as f:
    msl_data = pickle.load(f)

for image_name in tqdm(msl_data):
    ...
    with Image.open(next(msl_image_dir.glob(image_name + "*"))) as img:
    ...
    patch_population = msl_data[image_name]['patch-population']
    object_centroids = msl_data[image_name]['object-centriod']
    ...
    bounding_boxes = msl_data[image_name]['bounding-boxes']
    ...
    msl_data[image_name]['vqa-data'] = vqa_data

with open(output_filename, "wb") as f:
    pickle.dump(msl_data, f)